...
const planContent = {
  pt: [
    {
      name: 'Landing Page', label: 'Presença essencial', price: 'R$ 300', originalPrice: 'R$ 500', slotsTaken: 15, slotsTotal: 20, monthly: 'Suporte de R$ 49 a R$ 99/mês',
    ...
    {
      name: 'Site Completo', label: 'Autoridade digital', price: 'R$ 500', originalPrice: 'R$ 800', slotsTaken: 12, slotsTotal: 20, monthly: 'Suporte de R$ 79 a R$ 149/mês',
  ...
  en: [
    {
      name: 'Landing Page', label: 'Essential presence', price: 'R$ 300', originalPrice: 'R$ 500', slotsTaken: 15, slotsTotal: 20, monthly: 'Support from R$ 49 to R$ 99/month',
    ...
    {
      name: 'Complete Website', label: 'Digital authority', price: 'R$ 500', originalPrice: 'R$ 800', slotsTaken: 12, slotsTotal: 20, monthly: 'Support from R$ 79 to R$ 149/month',
              ...
              >
                ...
                {'originalPrice' in plan && plan.originalPrice ? (
                  <div className="pricing-promo">
                    ...
                    {'slotsTotal' in plan && plan.slotsTotal ? (
                      <div className="pricing-scarcity">
                        <div className="pricing-scarcity-head">
                          <strong>{plan.slotsTotal - plan.slotsTaken}</strong>
                          <span>{language === 'pt' ? 'vagas ainda com esse preço' : 'spots left at this price'}</span>
                        </div>
                        <div
                          className="pricing-scarcity-bar"
                          role="progressbar"
                          aria-valuemin={0}
                          aria-valuemax={plan.slotsTotal}
                          aria-valuenow={plan.slotsTaken}
                        >
                          <span style={{ width: `${(plan.slotsTaken / plan.slotsTotal) * 100}%` }} />
                        </div>
                        <p className="pricing-scarcity-note">
                          {language === 'pt'
                            ? `${plan.slotsTaken} de ${plan.slotsTotal} já saíram`
                            : `${plan.slotsTaken} of ${plan.slotsTotal} already taken`}
                        </p>
                      </div>
                    ) : null}
                  </div>
